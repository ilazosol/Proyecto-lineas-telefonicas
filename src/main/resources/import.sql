...
insert into lineas_moviles(estado,nombre_plan,numero_telefono,tipo_linea,cliente_id) values ("Cancelado","Plan Prepago",912356489,"Prepago",2);
...
insert into ofertas(descripcion,fecha_inicio,fecha_fin) values ("Oferta de 4 meses de 20 soles","2021-04-10","2021-08-10");
insert into ofertas(descripcion,fecha_inicio,fecha_fin) values ("Oferta de 2 meses de 40 soles","2021-05-13","2021-07-13");
insert into ofertas(descripcion,fecha_inicio,fecha_fin) values ("Oferta de 1 meses de 50 soles","2021-08-02","2021-09-02");
...
insert into linea_oferta values (1,1);
insert into linea_oferta values (1,2);
insert into linea_oferta values (1,3);
insert into linea_oferta values (1,4);
insert into linea_oferta values (2,5);
insert into linea_oferta values (3,3);
insert into linea_oferta values (4,6);
insert into linea_oferta values (5,7);
insert into linea_oferta values (6,5);