package com.telefonica.linea.app.lineasclientes.repository.conn;
...
public class ConexionJDBC {
    ...
    private static final Log LOG = LogFactory.getLog(ConexionJDBC.class);
    ...
    private static void init() {
        ...
        try {
            ...
            try (InputStream resource = ConexionJDBC.class.getResourceAsStream("/jdbc.properties")) {
    ...
    public static Connection conectarMySQLDB() throws Exception {
